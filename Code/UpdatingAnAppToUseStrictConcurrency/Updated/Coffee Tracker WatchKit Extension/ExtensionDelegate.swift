...
class ExtensionDelegate: NSObject, WKApplicationDelegate {
    ...
    let logger = Logger(
        subsystem:
            "com.example.apple-samplecode.Coffee-Tracker.watchkitapp.watchkitextension.ExtensionDelegate",
...
let scheduleLogger = Logger(
    subsystem:
        "com.example.apple-samplecode.Coffee-Tracker.watchkitapp.watchkitextension.scheduleLogger",
    category: "Scheduler")
